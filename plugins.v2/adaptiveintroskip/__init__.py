...
class AdaptiveIntroSkip(_PluginBase):
    ...
    # 插件图标
    plugin_icon = "https://raw.githubusercontent.com/f4cker/MoviePilot-Plugins/main/icons/chapter.png"
    # 插件版本
    plugin_version = "1.7.7"
    # 插件作者
    plugin_author = "f4cker"
    # 作者主页
    author_url = "https://github.com/f4cker"
    # 插件配置项ID前缀
                                ...
                                'content': [
                                    {
                                        ...
                                        'props': {
                                            'type': 'info',
                                            'variant': 'tonal',
                                            "text": "具体安装使用说明见README https://github.com/f4cker/MoviePilot-Plugins"
                                        }
                                    }
                                ]
                            }
